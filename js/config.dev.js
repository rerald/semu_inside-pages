...
// 개발 환경 특별 설정
window.DEBUG_MODE = true;  // 개발환경에서는 모든 로그 허용
...
console.log('🔍 All console logs are enabled in this environment');
